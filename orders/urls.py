...
from .views import (
    ...
    my_orders, customer_order_detail, customer_order_status_json,
    export_orders_csv,
)
...
urlpatterns = [
    ...
    path("owner/<int:pk>/prepare/", OwnerOrderPrepareView.as_view(), name="owner_order_prepare"),

    # Customer
    path("my/", my_orders, name="my_orders"),
    path("my/<int:pk>/", customer_order_detail, name="customer_order_detail"),
    path("my/<int:pk>/status.json", customer_order_status_json, name="customer_order_status_json"),
