...
class ProfileTests(TestCase):
    def setUp(self):
        self.user = User.objects.create_user(username="alice", email="a@a.com", password="secret123")
    ...
    def test_profile_update(self):
        ...
        resp = self.client.post(reverse("my_profile"), {"phone": "+41 79 123 45 67", "address": "Main St 1, Zurich"})
